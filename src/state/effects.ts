...
export const fetchEpisodes = createEffect({
  name: "fetchEpisodes",
  handler: async () => {
...
export const fetchEpisode = createEffect({
  name: "fetchEpisode",
...
export const fetchCharacters = createEffect({
  name: "fetchCharacters",
  handler: async (charactersUrls: string[]) => {
